...
<div class="admin-icerik-sag" style="float:left; margin-left:20px; border:1px
		...
		Konular <span style="float:right"><a href="/editor/?do=konu_ekle"><b>Konu Ekle</b></a></span></h2>
		...
		<th width="200">Konu Olayı</th>
		<th width="150">Konu İD</th>
  ...
  <div class="progress-bar progress-bar-striped bg-danger progress-bar-animated" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">Onaysız</div>
				 ...
				 ?>
					  ...
					  <td style="border: 1px solid #ddd; padding:10px;"><?php echo $m["konu_id"];?></td>
				 <td style="border: 1px solid #ddd; padding:10px;"><?php echo $m["konu_tarih"];?></td>
				 <td style="border: 1px solid #ddd;  padding:10px;"><span style="margin-left:30px;"><a type="button" class="btn btn-warning" href="/editor/?do=konu_duzenle&id=<?php echo $m["konu_id"]; ?>">Düzenle</a></span></td>
				 </tr>
