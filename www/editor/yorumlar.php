...
<div class="admin-icerik-sag" style="float:left; margin-left:20px; border:1px
  ...
  <div class="progress-bar progress-bar-striped bg-danger progress-bar-animated" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">Onaysız</div>
				 ...
				 <td style="border: 1px solid #ddd; padding:10px;"><?php echo $m["yorum_konu_id"];?></td>
				 <td style="border: 1px solid #ddd;  padding:10px;">
				 <form action="/editor/?do=toplu_onay" method="post">
				 <input type="checkbox" name="onayla[]" value="<?php echo $m["yorum_id"]; ?>" />
				 
				 <span style="margin-left:30px;"><a type="button" class="btn btn-warning" href="/editor/?do=yorum_duzenle&id=<?php echo $m["yorum_id"]; ?>">Düzenle</a></span>  <span><a type="button" class="btn btn-danger" href="/editor/?do=yorum_sil&id=<?php echo $m["yorum_id"]; ?>">Sil</a></span></td>
				 </tr>
