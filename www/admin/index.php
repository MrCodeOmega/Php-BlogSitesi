...
<head>
<meta charset="UTF-8">
<title>Blog Sitesi Admin Sayfa</title>
...
if($_SESSION){
	...
	height:160px;
	background:skyblue;">
		<h2 style="margin:50px 0px 30px;font-size:30px;"><a href="/admin/">Admin  <span style="color:blue;">Yönetim Paneli</span></a>
		...
		<ul>
		<li><a href="/admin/?do=anasayfa">Anasayfa</a></li>
