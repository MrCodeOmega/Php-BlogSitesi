...
<div class="admin-icerik-sag" style="float:left; margin-left:20px; border:1px
  ...
  <div class="progress-bar progress-bar-striped bg-danger progress-bar-animated" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100">Onaysız</div>
				 ...
				 <td style="border: 1px solid #ddd;  padding:10px;"><span style="margin-left:30px;"><a type="button" class="btn btn-warning" href="/admin/?do=uye_duzenle&id=<?php echo $m["uye_id"]; ?>">Düzenle</a></span>  <span><a type="button" class="btn btn-danger" href="/admin/?do=uye_sil&id=<?php echo $m["uye_id"]; ?>">Sil</a></span></td>
				 </tr>
