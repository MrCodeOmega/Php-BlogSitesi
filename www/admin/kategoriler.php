...
<div class="admin-icerik-sag" style="float:left; margin-left:20px; border:1px
		...
		<b>Kategoriler</b> <span style="float:right"><a href="/admin/?do=kategori_ekle"><b>Kategori Ekle</b></a></span></h2>
		...
		<?php
		 if($x){
			 ...
			 foreach($k as $m){
				 ...
				 <a type="button" class="btn btn-warning" href="/admin/?do=kategori_duzenle&id=<?php echo $m["kategori_id"]; ?>">
				 Düzenle</a></span>  <span>
				 <a type="button" class="btn btn-danger" href="/admin/?do=kategori_sil&id=<?php echo $m["kategori_id"]; ?>">
				 Sil</a></span></td>
				 </tr>
